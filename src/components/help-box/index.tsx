...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Gym Manager'];
  const customerRoles: string[] = ['End User'];
  const tenantRoles: string[] = ['Gym Manager', 'Business Owner', 'Customer Service Representative'];
  const addOns: string[] = ['chat', 'notifications'];
  const applicationName = `Fitternity`;
