...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['gym-manager', 'business-owner', 'customer-service-representative'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Day Pass', path: '/day-passes', entity: 'day_pass', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
